...
from aplikacjaogloszeniowa.models import Uzytkownik
...
class UpdateUzytkownikForm(forms.ModelForm):
    telefon = forms.CharField(validators=[check_number], label='Numer telefonu', max_length=9, required=False, widget=forms.TextInput(
        attrs={
            'class': 'form-control bg-light',
